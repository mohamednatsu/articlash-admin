              ...
              <div className="flex min-h-screen w-full bg-gray-50 pt-12 md:pt-0">
                     ...
                     >
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                                   <div>
                                          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Posts Reports Management</h1>
                                          <p className="text-gray-600">Review and take action on user posts reports</p>
                                   </div>
