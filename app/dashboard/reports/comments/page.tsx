...
import { FaComment, FaRegFlag } from "react-icons/fa";
...
const ReportsCommentsPage = () => {
       ...
       const fetchComments = async (reportId: number) => {
              ...
              const mockComments: Comment[] = [
                     {
                            id: 1,
                            text: 'your are not artist! why your art always is very bad ?',
                            createdAt: '2025-02-02T10:30:00',
                            reportId: reportId
                     },
                     {
                            id: 2,
                            text: 'it is not the art, this is *******',
                            createdAt: '2025-02-02T11:15:00',
                            reportId: reportId
                     },
                     {
                            id: 3,
                            text: 'Your art is very disgusting!',
                            createdAt: '2025-02-02T11:15:00',
                            reportId: reportId
                     },
              ];
              ...
              <div className="flex min-h-screen w-full bg-gray-50 pt-12 md:pt-0">
                     ...
                     >
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                                   <div>
                                          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Comments Report Management</h1>
                                          <p className="text-gray-600">Review and take action on user comments reports</p>
                                   </div>
                                                                      ...
                                                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                                                             ...
                                                                             <div className="bg-gray-50 p-4 rounded-lg">
                                                                                    <div className="flex items-center gap-2 mb-2">
                                                                                           ...
                                                                                           <h3 className="font-medium text-gray-800">Comment</h3>
                                                                                    </div>
                                                                                    <p className="text-gray-600">{report.comment?.text}</p>
                                                                             </div>
                                                                      </div>
